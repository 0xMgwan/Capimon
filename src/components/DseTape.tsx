...
type Board = { ok: boolean; lastTradeDate: string | null; ageDays: number | null; quotes: Quote[] };
...
export function DseTape() {
  ...
  // DSE closes overnight and at weekends, so the session label says which print
  // is on screen instead of implying the numbers are moving.
