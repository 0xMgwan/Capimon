...
export const SW: Record<string, string> = {
  ...
  "Nothing said about this one yet.": "Bado hakuna kilichosemwa kuhusu hii.",
  "comment": "maoni",
  "comments": "maoni",
  "Say something. Use @ to mention someone.": "Sema kitu. Tumia @ kumtaja mtu.",
  "Post": "Tuma",
  "Posting…": "Inatuma…",
  "Could not post your comment": "Imeshindikana kutuma maoni yako",
  "Sign in to join the conversation.": "Ingia ili kujiunga na mazungumzo.",
  "Remove": "Ondoa",
  "A customer": "Mteja",
  "No such handle.": "Hakuna jina hilo.",
  "Joined": "Alijiunga",
  "Trades": "Manunuzi",
  "Volume": "Kiasi",
  ...
  "By volume": "Kwa kiasi",
  "By return": "Kwa faida",
  "Nobody has published their trading yet.": "Bado hakuna aliyeonyesha manunuzi yake.",
  "trade": "manunuzi",
  "trades": "manunuzi",
  "traded": "yaliyofanyika",
  "realised": "iliyopatikana",
  "Show my trading to others": "Onyesha manunuzi yangu kwa wengine",
  "Puts your handle on the leaderboard and lets anyone who taps it see how many trades you have made, how much you have traded, what you have made or lost, and which shares you hold. Off unless you turn it on, and you can turn it off again whenever you like.":
    "Huweka jina lako kwenye jedwali la viongozi na humruhusu yeyote anayeligusa kuona idadi ya manunuzi yako, kiasi ulichofanyia biashara, faida au hasara yako, na hisa unazomiliki. Imezimwa hadi uiwashe, na unaweza kuizima tena wakati wowote.",
  "Notifications": "Arifa",
  ...
  "Enter the email or username on the account and we will send a link to set a new one.": "Weka barua pepe au jina la mtumiaji la akaunti nasi tutatuma kiungo cha kuweka jipya.",
  "you@example.com or @handle": "wewe@mfano.com au @jina",
  "Send the link": "Tuma kiungo",
  "Back to sign in": "Rudi kuingia",
  "Check your email.": "Angalia barua pepe yako.",
  "If there is a CAPX account for that email or username, a link to set a new password is on its way. It works once and expires in an hour.": "Kama kuna akaunti ya CAPX kwa barua pepe au jina hilo, kiungo cha kuweka nenosiri jipya kinakuja. Kinafanya kazi mara moja na kinaisha baada ya saa moja.",
  "Could not reach CAPX. Check your connection and try again.": "Imeshindwa kufikia CAPX. Angalia muunganisho wako kisha jaribu tena.",
  "Choose a new password.": "Chagua nenosiri jipya.",
  "This link works once. Setting a password also signs out anyone using the old one.": "Kiungo hiki kinafanya kazi mara moja. Kuweka nenosiri pia kunamtoa yeyote anayetumia la zamani.",
  "Type it again": "Liandike tena",
  "These do not match.": "Haya hayafanani.",
  "Set password": "Weka nenosiri",
  "Could not set your password": "Imeshindwa kuweka nenosiri lako",
  "This link is incomplete.": "Kiungo hiki hakijakamilika.",
  "Open the link from your email exactly as it was sent, or ask for a new one from the sign-in box.": "Fungua kiungo kutoka barua pepe yako kama kilivyotumwa, au omba kipya kwenye kisanduku cha kuingia.",
  "Back to CAPX": "Rudi CAPX",
  "Your password is set.": "Nenosiri lako limewekwa.",
  "Anyone who was signed in with the old one has been signed out. Sign in with the new password to continue.": "Yeyote aliyekuwa ameingia kwa la zamani ametolewa. Ingia kwa nenosiri jipya ili kuendelea.",
  /* Delivering a share to somebody's own wallet. */
  "Deliver to": "Peleka kwa",
  "CAPX account": "Akaunti ya CAPX",
  "My wallet": "Pochi yangu",
  "Delivering to your own wallet needs a verified CAPX account. Sign in, or open one — it takes a few minutes.": "Kupeleka kwenye pochi yako mwenyewe kunahitaji akaunti ya CAPX iliyothibitishwa. Ingia, au fungua moja — inachukua dakika chache.",
  "Your verification is under review. You can trade into your own wallet once it is approved.": "Uhakiki wako unapitiwa. Utaweza kufanya biashara hadi kwenye pochi yako mara utakapoidhinishwa.",
  "Verify your identity to trade into your own wallet.": "Thibitisha utambulisho wako ili kufanya biashara hadi kwenye pochi yako.",
  "Verify": "Thibitisha",
  "Connect the wallet you want the shares delivered to.": "Unganisha pochi unayotaka hisa zipelekwe.",
  "Switch your wallet to Base to continue.": "Badilisha pochi yako kwenda Base ili kuendelea.",
  "Sign a message to prove this wallet is yours. It approves nothing and cannot move funds — it is how CAPX knows which verified customer this address belongs to.": "Saini ujumbe kuthibitisha pochi hii ni yako. Haidhinishi chochote wala haiwezi kuhamisha fedha — ndiyo njia CAPX inajua anwani hii ni ya mteja gani aliyethibitishwa.",
  "Link this wallet": "Unganisha pochi hii",
  "Could not link that wallet": "Imeshindwa kuunganisha pochi hiyo",
  "Could not price that": "Imeshindwa kupanga bei hiyo",
  "That did not go through": "Hiyo haikupita",
  "You cancelled that in your wallet.": "Ulighairi hiyo kwenye pochi yako.",
  "The shares are sent to your wallet on Base. CAPX is the counterparty — the price is the same published DSE mark, converted at the nTZS rate.": "Hisa zinatumwa kwenye pochi yako kwenye Base. CAPX ndiye upande wa pili — bei ni ileile ya DSE iliyochapishwa, ikibadilishwa kwa kiwango cha nTZS.",
  "Send the shares back to CAPX and USDC comes to your wallet, at the same published mark.": "Rudisha hisa kwa CAPX na USDC itakuja kwenye pochi yako, kwa bei ileile iliyochapishwa.",
  "available to self-custody": "zinapatikana kwa kujihifadhia mwenyewe",
  "You pay, in USDC": "Unalipa, kwa USDC",
  "You send": "Unatuma",
  "You pay first, then CAPX sends. Both legs are on Base and you will see each one in your wallet.": "Unalipa kwanza, kisha CAPX inatuma. Hatua zote mbili ziko kwenye Base na utaziona zote kwenye pochi yako.",
  "is in your wallet.": "iko kwenye pochi yako.",
  "Your USDC is on its way.": "USDC yako inakuja.",
  "Pricing…": "Inapanga bei…",
  "Confirm in your wallet…": "Thibitisha kwenye pochi yako…",
  "Settling…": "Inakamilisha…",
  ...
  /* Activity, and linking a wallet before it is needed. */
  "Your activity.": "Shughuli zako.",
  "Everything that has moved, newest first. Tap a row for the receipt.": "Kila kilichohama, kipya kwanza. Gusa safu kuona risiti.",
  "Sign in to see every deposit, trade and withdrawal on your account, with the receipt for each one.": "Ingia kuona kila amana, biashara na utoaji kwenye akaunti yako, pamoja na risiti ya kila moja.",
  "Everything": "Yote",
  "Money in and out": "Pesa zinazoingia na kutoka",
  "Needs attention": "Zinahitaji uangalizi",
  "Nothing has moved yet. Your first deposit will show up here.": "Hakuna kilichohama bado. Amana yako ya kwanza itaonekana hapa.",
  "Nothing here.": "Hakuna kitu hapa.",
  "Tanzanian shares carry no dividend entitlement, so none appears here. US shares reflect dividends through the token's on-chain multiplier, which changes what a holding is worth rather than paying into an account.": "Hisa za Tanzania hazina haki ya gawio, hivyo hakuna linaloonekana hapa. Hisa za Marekani zinaonyesha gawio kupitia kizidishi cha tokeni kwenye blockchain, ambacho hubadilisha thamani ya kile unachoshikilia badala ya kulipa kwenye akaunti.",
  "Withdrawal": "Utoaji",
  "Adjustment": "Marekebisho",
  "wallet": "pochi",
  "from wallet": "kutoka pochi",
  "Pending": "Inasubiri",
  ...
  "Order": "Agizo",
  "Transaction": "Muamala",
  "nTZS reference": "Kumbukumbu ya nTZS",
  "nTZS deposit": "Amana ya nTZS",
  "Transfer": "Uhamisho",
  "Paid from": "Imelipwa kutoka",
  "Reference": "Kumbukumbu",
  "Your payment": "Malipo yako",
  "CAPX transfer": "Uhamisho wa CAPX",
