...
export const SW: Record<string, string> = {
  ...
  "CAPX buys the shares back from you at the current price and puts the shillings, less the 1% fee, into your balance immediately. Those shares go back into CAPX's stock, ready for the next buyer.": "CAPX inanunua hisa hizo kutoka kwako kwa bei ya sasa na kuweka shilingi, ukiondoa ada ya 1%, kwenye salio lako mara moja. Hisa hizo zinarudi kwenye akiba ya CAPX, tayari kwa mnunuzi anayefuata.",
